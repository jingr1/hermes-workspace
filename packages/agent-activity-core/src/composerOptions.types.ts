...
export interface AgentActivityComposerOptions {
  ...
  /** Mirrors agoraxd modelConfig.configurable; false when absent. */
  ...
  /** Mirrors agoraxd reasoningConfig.configurable; false when absent. */
  reasoningConfigurable?: boolean;
  /** Mirrors agoraxd speedConfig.configurable; false when absent. */

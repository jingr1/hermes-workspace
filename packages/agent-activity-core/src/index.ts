...
export {
  ...
  selectAgoraxModeDraftPreferences,
  agoraxModeActivationPresentationsEqual,
  type ResolvedAgoraxModeActivationPresentation,
  type AgoraxModeActivationPresentation
} from "./engine/agoraxModeActivation.selectors.ts";
export type {
  AgoraxModeActivationCommand,
  AgoraxModeActivationIntent,
  AgoraxModeActivationState,
  AgoraxModeActivationUpdateCommand
} from "./engine/agoraxModeActivation.types.ts";
export {
...
export type {
  ...
  AgentActivityAgoraxModeActivationRevision,

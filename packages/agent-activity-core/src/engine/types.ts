 ...
 * agoraxd runtime versus an external shared-room runtime), and is a first-class
...
export interface AgentSessionEngineStateBase {
  ...
  agoraxModeActivation: AgoraxModeActivationState;
}
...
export type AgentSessionActivateEffectInput =
  | (AgentSessionActivateEffectInputBase & {
      ...
      initialAgoraxModeActivation?: AgentActivityInitialAgoraxModeActivation;
      mode: "new";
    })
  | (AgentSessionActivateEffectInputBase & {
...
export type AgentSessionActivationInput =
  | (AgentSessionActivationInputBase & {
      ...
      agoraxModeDraftKey?: string;
    })
  | (AgentSessionActivationInputBase & {
      agentTargetId?: string | null;
      clientSubmitId?: never;
      initialGoalControl?: never;
      initialAgoraxModeActivation?: never;
      mode: "existing";
      optimisticTitle?: never;
      agoraxModeDraftKey?: never;
    });

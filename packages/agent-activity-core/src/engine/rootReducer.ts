...
export function createInitialAgentSessionEngineState(): RootAgentSessionEngineState {
  return {
    ...
    agoraxModeActivation: createInitialAgoraxModeActivationState()
  };
}
...
export function rootEngineReducer(
  ...
  const agoraxModeActivation = agoraxModeActivationReducer(
    state.agoraxModeActivation,
    intent,
    { sessionsById: sessionLifecycle.state.sessionsById }
  );
  const unchanged =
    ...
    agoraxModeActivation.state === state.agoraxModeActivation;
  const nextState = unchanged
    ...
    : {
        ...
        agoraxModeActivation: agoraxModeActivation.state
      };

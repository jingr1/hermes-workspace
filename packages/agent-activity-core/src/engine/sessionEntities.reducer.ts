...
function preserveProjectedSessionState(
  ...
  const goalSyncState =
    ...
    !Object.prototype.hasOwnProperty.call(incoming, "goalSyncState")
      ...
      : undefined;
  const agoraxModeActivation =
    current?.agoraxModeActivation &&
    (!incoming.agoraxModeActivation ||
      incoming.agoraxModeActivation.currentRevision.revision <
        current.agoraxModeActivation.currentRevision.revision)
      ? current.agoraxModeActivation
      : undefined;
  const preserved = {
    ...incoming,
    ...
    ...(agoraxModeActivation === undefined ? {} : { agoraxModeActivation })
  };
  if (

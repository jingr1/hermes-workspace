  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running Agorax, then sign in.',
    ...
    },
    {
      ...
      body: 'Agorax can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
    ...
    {
      title: 'Open Agorax on your phone',
      body:

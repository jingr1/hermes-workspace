...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/jingr1/agorax/main/install.sh | bash
#
# What it does:
...
REPO_URL="${REPO_URL:-https://github.com/jingr1/agorax.git}"
INSTALL_DIR="${INSTALL_DIR:-$HOME/agorax}"

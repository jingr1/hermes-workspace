...
func logActiveActionSet(provider string, action ActiveAction) {
	...
	slog.Info(
		...
		"event", "agorax.agent_provider.active_action.set",
		"provider", provider,
		"actionId", action.ID,
...
func appendActiveActionStdout(ctx context.Context, provider string, output string) {
	...
	slog.Info(
		...
		"event", "agorax.agent_provider.active_action.output_appended",
		"provider", provider,
...
func clearActiveAction(ctx context.Context, provider string) {
	...
	slog.Info(
		...
		"event", "agorax.agent_provider.active_action.cleared",
		"provider", provider,
